...
//#import "UIImageView+yimAFNetworking.h"
...
//    cell.imageView.image = image;
    NSString *imageURL = self.imageURLStringsGroup[itemIndex];
    if ([imageURL isEqual:[NSNull null]] || imageURL.length == 0) {
        imageURL = @"";
    }
//    [cell.imageView downImage:imageURL placeholder:self.placeholderImage completionHandler:^(NSURLResponse *response, NSURL *filePath, UIImage *image, NSError *error) {
//        //
//        //NSLog(@"...SDCycleScrollView complete");
//    }];
