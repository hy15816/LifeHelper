...
//        CGFloat notificationWidth = notificationRect().size.width;
        ...
        _contentView.colors = @[(id)[[UIColor colorWithWhite:0.95f alpha:1.0f] CGColor],
...
//                                      2,
//                                      self.frame.size.width - __imagePadding * 2 - CGRectGetMaxX(_imageView.frame),
//                                      textFont.lineHeight);
...
//        [_contentView addSubview:_textLabel];
        ...
        // detail text
        UIFont *detailFont = [UIFont systemFontOfSize:15.0f];
        CGRect detailFrame = CGRectMake(5, 2, self.bounds.size.width - 10, 40);
...
+ (MPNotificationView *) notifyWithText:(NSString*)text {
    ...
    return [self notifyWithText:nil detail:text andDuration:2.0f];
}
