...
- (void)viewDidLoad {
    ...
    LSScrollItemView *itemView = [[LSScrollItemView alloc] initWithFrame:CGRectMake(0, 100, self.view.frame.size.width, 200) titles:@[@"一",@"二",@"三",@"四"] block:^(LSScrollItemView *itemView,NSInteger index){
        NNLog(@"---------:%d",index);
    }];
